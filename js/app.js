...
let offsetContent =
  document.getElementById('quienes-somos').offsetTop

window.addEventListener('scroll', function () {
  let y = document.documentElement.scrollTop
  if (y + 60 > offsetContent) {
    document
      .getElementById('sec-nav')
...
// Modals logic
const imgsContainers = document.querySelectorAll(
  '.img-container',
)
...
const navSlide = () => {
  ...
  const navLinksMini =
    document.querySelectorAll('.nav-mini li')
...
// Enlaces Show
const enlacesShow = [
  ...document.querySelectorAll('.enlaces__show'),
]
